...
// THIS IS ALL COPIED FROM "github.com/google/go-querystring/query"
// changed from using the 'url' to 'json' struct tag for encoding.
...
func ParseValues(v interface{}) (url.Values, error) {
